...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($conn, "UPDATE `categorios` SET name = '$update_p_name', Price = '$update_p_price', image = '$update_p_image' WHERE id = '$update_p_id'");
...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
   ...
   <input type="submit" value="add the product" name="add" class="btn">
</form>

</section>-->
<header class="head">
<button><a href="Admin_panel.html">Home</a></button>
<button><a href="Admin_panel.html">Back</a></button>
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <img src="uploads/<?php echo $fetch_edit['image']; ?>" height="200" alt="">
