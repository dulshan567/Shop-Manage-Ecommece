   ...
   <div class="box-container">
      ...
      <form action="" method="post">
         ...
         <div class="box">
            ...
            <h3><?php echo $fetch_product['Item_name']; ?></h3>
            
            <div class="Price">LKR <?php echo $fetch_product['Price']; ?>/-</div>
              
            <p><p><h5><?php echo $fetch_product['Descriptions']; ?></h5></p></p>
            <input type="hidden" name="Item_name" value="<?php echo $fetch_product['Item_name']; ?>">
