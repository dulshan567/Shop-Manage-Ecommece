...
<div class="sidebar">
    ...
    <div class="sidebar-menu">
        <ul>
            <li>
                <a href="Admin_panel.php" class=""><span class="las la-igloo"></span>
                <span>Dashboard</span></a>
            </li>
            <li>
                <a href="Customer_page.php" class="Customers"><span class="las la-shipping-bag"></span>
